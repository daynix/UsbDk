...
"C:\Program Files (x86)\WiX Toolset v3.8\bin\light.exe" UsbDk_Debug.wixobj -out UsbDk_Debug_x86.msi -sw1076
if !ERRORLEVEL! NEQ 0 exit /B 1
...
del UsbDk_Debug_x64.msi UsbDk_Debug_x64.msi.wixobj UsbDk_Debug_x64.msi.wixpdb
...
if !ERRORLEVEL! NEQ 0 exit /B 1
"C:\Program Files (x86)\WiX Toolset v3.8\bin\light.exe" UsbDk_Debug.wixobj -out UsbDk_Debug_x64.msi -sw1076
if !ERRORLEVEL! NEQ 0 exit /B 1
...
del UsbDk_x86.msi UsbDk_x86.wixobj UsbDk_x86.wixpdb
...
if !ERRORLEVEL! NEQ 0 exit /B 1
"C:\Program Files (x86)\WiX Toolset v3.8\bin\light.exe" UsbDk.wixobj -out UsbDk_x86.msi -sw1076
if !ERRORLEVEL! NEQ 0 exit /B 1
...
if !ERRORLEVEL! NEQ 0 exit /B 1
"C:\Program Files (x86)\WiX Toolset v3.8\bin\light.exe" UsbDk.wixobj -out UsbDk_x64.msi -sw1076
if !ERRORLEVEL! NEQ 0 exit /B 1
